    ...
    mountainVillage: [
      {
        ...
        trails: [
          ...
          { name: "Quinton Time", difficulty: "blue", desc: "More road segments; Creole is the better choice" }
        ]
      },
      {
        lift: "Eagle",
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Silver Hollow", difficulty: "blue", desc: "Quite mild for a blue, only accessible from Three Kings" },
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Blanch", difficulty: "green", desc: "Standard green with adventure zone running parallel" },
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Erica's Gold", difficulty: "black", desc: "Biggest and baddest moguls on this ridge" },
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Sikka", difficulty: "blue", desc: "Groomed nightly; favorite run in pod" },
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Ligy Split", difficulty: "black", desc: "Standard mogul run" },
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Jonesies", difficulty: "blue", desc: "Fantastic cruiser, favorite in pod; touch steep on first pitch" },
          ...
          { name: "Bergsbowl", difficulty: "black", desc: "Short, steep, doesn't hold snow; don't recommend" },
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Carbide Cut", difficulty: "blue", desc: "Groomed nightly; last chance to access Motherload — TAKE IT" },
          { name: "Motherload Meadows", difficulty: "double-black", desc: "Deceptively mild start", warning: "Earns double black in super steep tight trees lower half — do NOT be fooled by the entrance" },
      ...
      {
        lift: "Motherload Express",
        liftInfo: "lines a fraction of Silver Load — ALWAYS choose this over Silver Load",
        trails: [
      ...
      },
      {
        ...
        trails: [
          { name: "Georgana", difficulty: "blue", desc: "Groomer with mix of road and traditional slope sections" },
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Limelight", difficulty: "double-black", desc: "Lower half rarely open; may require flat traverse" }
        ]
      }
    ],
    canyons: [
      ...
      },
      {
        ...
        liftInfo: "MAJOR choke point — the Silver Load of the canyon side",
        trails: [
      ...
      },
      {
        ...
        trails: [
          ...
          { name: "Talis Garden", difficulty: "black", desc: "Moguls → open meadow → narrow gully to Peak 5" }
        ]
      },
      {
        lift: "Peak 5",
      ...
      },
      {
        ...
        trails: [
          { name: "Deja Vu", difficulty: "blue", desc: "Fantastic blue mogul run; best blue moguls at PC" },
          { name: "Bliss", difficulty: "blue", desc: "Fantastic blue mogul run; somewhat hidden — favorite", warning: "Access via Deja Vu, go under lift" },
          { name: "Snow Meadow", difficulty: "blue", desc: "Widest and mellowest blue mogul run" },
          { name: "Alpenlow", difficulty: "black", desc: "Ridge line, consistently groomed; gets narrow at bottom merge" },
      ...
      },
      {
        ...
        trails: [
          { name: "Fantasm", difficulty: "black", desc: "Great long cruiser; rotating grooming; skis well days after groom" },
          ...
          { name: "Spectre / Fool's Paradise", difficulty: "black", desc: "Several cut mogul lines + solid tree skiing; watch for thickets at bottom" },
      ...
      },
      {
        ...
        trails: [
          { name: "Blaze's Way", difficulty: "blue", desc: "Great upper 2/3; gets flat at bottom" },
          { name: "Highway", difficulty: "blue", desc: "Great upper 2/3; flat at bottom" },
          { name: "Snow Wonder", difficulty: "blue", desc: "Nice continuous cruiser all the way down" },
          { name: "Mimi's Way", difficulty: "blue", desc: "Off Blaze's Way", warning: "DO NOT turn onto — dead-ends at wrong end of Flat Iron with NO signs" }
        ]
      }
    ]
  },
    ...
    mountainVillage: [
      {
        ...
        steps: [
          ...
          { icon: "🚡", instruction: "Ride Motherload Express up", detail: "Lines a fraction of Silver Load. You are now on the mid-mountain.", success: true }
        ]
      },
      {
        id: 2,
        name: "Motherload → Pioneer → McConkey's",
        subtitle: "Quiet Terrain",
        steps: [
          { icon: "🚡", instruction: "Start at top of Motherload or Bonanza", detail: "" },
          ...
          { icon: "🎿", instruction: "Ski Georgana (blue) or Tycoon (black)", detail: "Step up difficulty as desired" }
        ]
      },
      {
        id: 3,
        ...
        steps: [
          ...
          { icon: "🔄", instruction: "Exit via upper Thaynes Canyon", detail: "Back to Jupiter or Motherload" }
        ]
      },
      {
        id: 4,
        name: "Avoiding Silver Load",
        subtitle: "Critical Detour",
        steps: [
          { icon: "📍", instruction: "You're at Bonanza top or King Con top", detail: "" },
          { icon: "❌", instruction: "Do NOT follow crowds toward Silver Load", detail: "Worst crowds in all of Park City", warning: true },
          ...
          { icon: "⬅️", instruction: "At lower fork, go LEFT onto Carbide Cut", detail: "Groomed nightly — LAST chance to escape to Motherload" },
          { icon: "🚡", instruction: "Ride Motherload Express", detail: "Fraction of Silver Load's lines", success: true },
      ...
      },
      {
        ...
        steps: [
          ...
          { icon: "🎿", instruction: "Option C: King Con → Gotcha Cutoff → base", detail: "Avoids the Crescent/Silver Load choke point" },
    ...
    canyons: [
      ...
      },
      {
        ...
        steps: [
          ...
          { icon: "⬅️", instruction: "Take Alpenlow down the ridge", detail: "Consistently groomed; gets narrow at bottom merge" },
          { icon: "⬅️", instruction: "Turn onto Deja Vu for blue moguls", detail: "Or access Bliss (hidden — go under lift via Deja Vu)" },
          { icon: "🚡", instruction: "Back up Dreamscape", detail: "" },
          { icon: "⬅️", instruction: "Take Alpenlow → Twilight or Mirage", detail: "Blue groomers to Dreamcatcher" },
          { icon: "🚡", instruction: "Ride Dreamcatcher up", detail: "15+ min ride with constant stops", warning: true },
          { icon: "🎿", instruction: "Ski Fantasm or Boogeyman", detail: "Skip Pipedream unless groomed overnight — icy" },
      ...
      },
      {
        ...
        steps: [
          ...
          { icon: "📍", instruction: "You arrive at Tombstone area (PC side)", detail: "Take Thaynes Canyon down to Motherload or King Con" },
  ...
  strategy: {
    mountainVillage: {
      ...
      recommendedFlow: [
        ...
        { text: "Bonanza → fork: RIGHT to Silver Load area (avoid!) — take Carbide Cut to Motherload Express instead (fraction of the lines). LEFT to Pioneer pod — most underrated area, quietest blue cruisers, best lunch at Mid-Mountain Lodge.", type: "step" },
      ...
      routingTips: [
        { text: "From King Con, take the Crescent runs to exit — NOT Silver Load. This avoids a major choke point.", type: "tip" },
        ...
        { text: "Thaynes pod is accessible from Motherload or Single Jack — the fixed grip double isn't as bad as you'd think.", type: "tip", warning: "Motherload Meadows — Deceptively mild start. Earns double black in lower half. Do not be fooled." },
    ...
    canyons: {
      ...
      routingTips: [
        ...
        { text: "Mimi's Way off Blaze's Way is a trap — dead-ends at wrong side of Flat Iron with NO signs.", type: "tip", warning: "Do NOT turn onto Mimi's Way." },
  ...
  trees: {
    best: {
      ...
      canyons: [
        ...
        { name: "Spectre / Fool's Paradise", difficulty: "black", lift: "Dreamcatcher", location: "Dreamcatcher pod", notes: "Several cut lines with solid tree skiing; watch for thickets at bottom" },
  ...
  maps: {
    mountainVillage: {
      ...
      nodes: [
        ...
        { id: "three-kings", name: "Three Kings", info: "Triple — terrain parks", type: "standard", zone: "base" },
        ...
        { id: "silver-load", name: "Silver Load", info: "WORST crowds — AVOID", type: "avoid", zone: "mid" },
        { id: "motherload", name: "Motherload Express", info: "Fraction of Silver Load lines", type: "recommended", zone: "mid" },
    ...
    canyons: {
      ...
      connections: [
        ...
        { from: "dreamscape", to: "dreamcatcher", label: "Alpenlow" },
    ...
    crossMountain: {
      ...
      routes: [
        ...
        { name: "Midstation Route", steps: "Quicksilver midstation → Blaze's Way / Highway (blue cruisers) → Dreamcatcher", type: "standard" },
        { name: "Pine Cone Ridge", steps: "Jupiter (PC side) → Scotsbull → hike → Limelight access → Quicksilver midstation", type: "expert" },
